...
public class Executable {
    ...
    public static void main(String[] args) {
        System.out.println(java.util.Arrays.toString(test1MyBubbleSort()));
    ...
    public static int[] test1MyBubbleSort() {
        int[]tabtest1= new int[4];
        for (int i=0; i<4; i++){
            Random rand = new Random();
            int randnumber = rand.nextInt(100);
            tabtest1[i]=randnumber;
        }
        Tools.sortBubble(tabtest1);
        return tabtest1;
    }
    ...
    public static int[] testRandomMyBubbleSort(int n, int seed) {
        ...
        for (int i=0; i<n ; i++){
            ...
            tabtosort[i]=randnumber;
        }
        Tools.sortBubble(tabtosort);
        return tabtosort;
    }
}