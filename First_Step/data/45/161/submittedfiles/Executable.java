...
public class Executable {
    ...
    public static void main(String[] args) {
        ...
        //TODO
        //int [] tab= {2,3,5,1,4};
       // int [] a = Tools.sortBubble(tab);
        //System.out.println(a);
        /// non Tools.sortBubble (Tools avec un s...) ne renvoie pas une String que tu peux afficher
        /// Tools.sortBubble(tab) trie le tableau tab
        /// a toi ensuite de l'afficher case par case pour vérifier qu'il est bien trié
    }
